...
router.post('/register', async (req, res) => {
    try {
        ...
        // Check uniqueness
        const existingResult = await db.getUserByUsername(body.username);
        if (existingResult) {
        ...
        const userDTO = { id, username: body.username, displayName: body.displayName };
...
router.post('/login', async (req, res) => {
    try {
        ...
        const userResult = await db.getUserByUsername(body.username);
        if (!userResult) {
