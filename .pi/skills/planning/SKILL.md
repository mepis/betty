---
name: planning
description: "Create detailed implementation plans for feature requests, enhancements, and refactoring. Always use before starting any coding task. Outputs plans only — never modifies source code."
allowed-tools: Read, Write, Edit, Bash, Glob, Grep
---

# Planning Skill

Create a detailed, actionable implementation plan for the user's request. Present the plan for approval before any implementation begins.
...
2. **Plan** — Develop a phased implementation plan with concrete tasks.
3. **Review** — Self-validate: verify every step is atomic, dependencies are resolved, and acceptance criteria are clear.
4. **Present** — Output the plan for human review. Do not implement until approved.

> **You have permission to create all documentation files (plans, notes, etc.) related to this task. Do not modify any existing code. Create documentation files only.**
