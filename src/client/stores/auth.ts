...
export const useAuthStore = defineStore('auth', () => {
  ...
  const token = ref<string>(localStorage.getItem('betty_token') || '');
  ...
  async function register(username: string, displayName: string, password: string): Promise<AuthResponse> {
