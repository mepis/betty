...
// Profile state
const profiles = ref([])
const showProfilePanel = ref(true)
...
const showServiceProfilePanel = ref(true)
...
<template>
  <div class="m-2 grid grid-cols-1 lg:grid-cols-[1fr_3fr_3fr] gap-4 mb-6">
    <!-- Left column -->
    <div class="space-y-4">
    <!-- Actions Panel -->
    <div class="card">
      ...
      <div v-if="showActionsPanel" class="flex flex-col justify-end space-y-3">
        <!-- Kill Port -->
        <button
